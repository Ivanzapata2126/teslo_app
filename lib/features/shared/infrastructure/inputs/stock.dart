...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == StockError.value ) return 'El campo debe ser un número mayor o igual a 0';
    if ( displayError == StockError.format ) return 'El campo no tiene formato de número';
